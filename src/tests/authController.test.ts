...
describe('AuthController', () => {
  ...
  describe('handleLogin', () => {
    it('should generate a random state and redirect to authorization URL', async () => {
      ...
      const expectedUrl = 'https://accounts.spotify.com/authorize?response_type=code&client_id=test_client_id&scope=user-read-private+user-read-email&redirect_uri=http%3A%2F%2Flocalhost%2Fcallback&state=random_state';
